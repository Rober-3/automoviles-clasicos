				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<a class="nav-link collapsed" href="#" data-toggle="collapse"
							data-target="#collapseClasicos" aria-expanded="false"
							aria-controls="collapseClasicos">
							<div class="sb-nav-link-icon">
						...
						<div class="collapse" id="collapseClasicos"
							aria-labelledby="headingOne" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<!-- ClasicosBackOfficeController -->
								<a class="nav-link" href="views/backoffice/clasicos">Total</a> <a
									class="nav-link"
									href="views/backoffice/clasicos?validados=no&total=no">Pendientes</a>
								<a class="nav-link" href="views/backoffice/clasicos?total=no">Publicados</a>
							</nav>
						</div>

						<a class="nav-link collapsed" href="#" data-toggle="collapse"
							data-target="#collapseMarcas" aria-expanded="false"
						...
						<div class="collapse" id="collapseMarcas"
							...
							<nav class="sb-sidenav-menu-nested nav">
								...
								<a class="nav-link" href="views/backoffice/marcas">Total</a> <a
									class="nav-link"
									href="views/backoffice/marcas?validadas=no&total=no">Pendientes</a>
								<a class="nav-link" href="views/backoffice/marcas?total=no">Publicadas</a>
							</nav>
						</div>

						<a class="nav-link collapsed" href="#" data-toggle="collapse"
							data-target="#collapseUsuarios" aria-expanded="false"
